...
from models.transformer_fixpe import Transformer, TransformerEncoder, TransformerDecoderLayer, \
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='Trans_grid_EMFM')
